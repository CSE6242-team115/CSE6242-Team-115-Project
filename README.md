...
- (Optional and not recommended — only if generating the JSON file yourself)
	Run Algorithm2.py in Python to recreate artworksGalNumKnown.json (We have included artworksGalNumKnown.json upon setup as running the Algorithm2.py file to build the JSON file takes multiple hours to run)
